...
return (
  <div className="pool-content h-full">
    ...
    <div className="w-full h-1 bg-[#333] rounded overflow-hidden mb-4">
      <div
        className="h-full bg-[#60A5FA] transition-all duration-1000 ease-linear"
    ...
    <div className="h-full">
      {isRefreshing ? (
        /* Refreshing state */
        <div className="artist-pool-state artist-pool-state--refreshing flex flex-col items-center justify-center h-full w-full text-gray-500">
          <LoadingSpinner />
        ...
        /* Empty state */
        <div className="artist-pool-state artist-pool-state--empty flex flex-col items-center justify-center h-full w-full text-gray-500">
