// useStarfieldNavigation.js - Enhanced hook for navigating between constellations
import { useCallback, useEffect, useState } from "react";
import { TOTAL_WIDTH, TOTAL_HEIGHT, generateFriends } from "../starfieldCore";

export function useStarfieldNavigation(containerRef, containerDimensions, isFullscreen, scrollPos) {
