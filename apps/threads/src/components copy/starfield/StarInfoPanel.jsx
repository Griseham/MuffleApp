    ...
    >
      ...
      <button
        ...
        style={{
          ...
          height: '28px',
          borderRadius: '50%',
          backgroundColor: hasBeenClicked ? 'rgba(128, 128, 128, 0.3)' : 'rgba(255, 215, 0, 0.3)',
          boxShadow: hasBeenClicked ? '0 0 8px rgba(128, 128, 128, 0.3)' : '0 0 8px rgba(255, 215, 0, 0.5)',
          border: 'none',
          cursor: 'pointer',
          padding: 0,
          transition: 'all 0.2s ease',
          animation: hasBeenClicked ? 'none' : 'pulse 3s infinite',
          position: 'absolute',
          top: '10px',
          right: '50px',
          zIndex: 1000
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.backgroundColor = hasBeenClicked ? 'rgba(128, 128, 128, 0.5)' : 'rgba(255, 215, 0, 0.5)';
          e.currentTarget.style.boxShadow = hasBeenClicked ? '0 0 12px rgba(128, 128, 128, 0.5)' : '0 0 12px rgba(255, 215, 0, 0.7)';
          e.currentTarget.style.animationPlayState = 'paused';
        }}
        onMouseLeave={(e) => {
          e.currentTarget.style.backgroundColor = hasBeenClicked ? 'rgba(128, 128, 128, 0.3)' : 'rgba(255, 215, 0, 0.3)';
          e.currentTarget.style.boxShadow = hasBeenClicked ? '0 0 8px rgba(128, 128, 128, 0.3)' : '0 0 8px rgba(255, 215, 0, 0.5)';
          e.currentTarget.style.animationPlayState = 'running';
        }}
      >
        <Info size={16} color={hasBeenClicked ? "#ddd" : "#FFD700"} />
      </button>
