// UserAvatarLayer.jsx - Renders user and friend avatars with boundary circles
import React, { useMemo, useContext } from "react";
import styles from "../starfieldStyles";
import { generateFriends, TOTAL_WIDTH, TOTAL_HEIGHT, friendColors } from "./extendedStarfieldUtils";
import { StarfieldContext } from "../context/StarfieldContext";

export default function UserAvatarLayer({ snapToFriend }) {
  ...
  return (
    <>
      ...
      <React.Fragment>
        ...
        {/* "For You" label inside the boundary circle */}
        <div style={{
          ...(isFullscreen ? styles.forYouLabelFS : styles.forYouLabelWindowed),
          ...styles.forYouLabel,
          left: TOTAL_WIDTH / 2,
          top: TOTAL_HEIGHT / 2 - 200, // Position above center
        }}>
          Your For You
        </div>
      ...
      {friends.map((f, idx) => {
        ...
        return (
          <React.Fragment key={f.id}>
            ...
            {/* Friend label inside the boundary circle */}
            <div style={{
