// GenreWheelContainer.jsx - Manages the wheel positioning and transitions
import React, { useState, useEffect, useRef, useContext, useMemo } from "react";
import ModernGenreWheel from "../ModernGenreWheel";
import InfoIconModal from "../InfoIconModal";
import { generateArcSets } from "../genreUtils";
import { GENRE_CHANGE_THRESHOLD, TOTAL_WIDTH, TOTAL_HEIGHT } from "../starfieldCore";
import { StarfieldContext } from "../context/StarfieldContext";
import { Music, Compass, Stars } from "lucide-react";

export default function GenreWheelContainer({ forcedGenres = null }) {
  const { 
    scrollPos,
    isFullscreen,
    containerDimensions,
  ...
  <InfoIconModal
    ...
    steps={[
      ...
      },
      {
        icon: <Stars size={20} color="#a9b6fc" />,
        title: "Discovered Artists",
        content: "Discovered artists represents the artists you follow/discovered while using the app"
      },
      {
        icon: <Stars size={20} color="#a9b6fc" />,
        title: "Discovered Artists",
